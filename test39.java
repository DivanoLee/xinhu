...
public class x39 extends BaseTest{
	@Test(priority=0)
	...
	public void Test39() throws InterruptedException{
		...
		webtest.click("xpath=//div[@onclick='clickmenu(this,7,-1)']");
		webtest.click("xpath=//div[@onclick='clickmenu(this,7,0)']");
		webtest.click("xpath=//div[@click='testss,0']");
	}
}
