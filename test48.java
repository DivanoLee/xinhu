...
public class x48 extends BaseTest{
	@Test(priority=0)
	...
	public void Test48() throws InterruptedException{
		...
		webtest.click("xpath=//div[@onclick='clickmenu(this,3,1)']");
		webtest.click("xpath=//div[@onclick='openchat(31,1)']");
		webtest.type("xpath=//input[@id='contentdiv']","sdddda");
		webtest.click("xpath=//div[@tools='send']");
